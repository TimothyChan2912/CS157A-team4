...
<body>
    ...
    <button class="listings-button" onclick="location.href='add_gyms.jsp'">Add Gyms</button>
    <button class="listings-button" onclick="location.href='view_requested_listings.jsp'">View Requested Listings</button>
