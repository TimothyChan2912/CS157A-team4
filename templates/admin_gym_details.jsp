...
<body>
    ...
    <div class="main-content">
        <button class="back-button" onclick="location.href='admin_view_listings.jsp'">Back to Listings</button>
    					...
    					<div class="gym-container recent-reviews-container">
        					...
        					%>
    							...
    							<div class="review-body">
    							    ...
    							    <div class="review-actions" style="text-align: right; margin-top: 10px;">
								        <form method="post" action="admin_delete_review.jsp" onsubmit="return confirm('Are you sure you want to delete this review?');">
								            <input type="hidden" name="reviewID" value="<%= rs.getInt("Review_ID") %>">
								            <input type="hidden" name="gymID" value="<%= gymID %>">
								            <button type="submit" class="cancel-button">Delete Review</button>
								        </form>
								    </div>
								</div> <!-- this closes .review-box -->
